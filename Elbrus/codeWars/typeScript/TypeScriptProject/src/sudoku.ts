...
function cubeBoard(board: any[][]): number[][] {
    ...
    allCubes.push(
        ...threeCubesAllFirstElement,
        ...threeCubesAllMediumElement,
        ...threeCubesAllBottomElement
    )
    return allCubes
}
